...
population_2010 <- censuskor %>%
  filter(year == 2010, type == "population", class2 == "total", class2 == "total")
population_2015 <- censuskor %>%
  filter(year == 2015, type == "population", class2 == "total", class2 == "total")
population_2020 <- censuskor %>%
  filter(year == 2020, type == "population", class2 == "total", class2 == "total")
