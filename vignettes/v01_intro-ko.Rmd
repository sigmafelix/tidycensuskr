...
* 이 패키지에서 제공하는 자료는 대한민국 통계데이터처에서 2010년-2020년 작성하여 공공누리 제1유형으로 개방한 통계표를 이용하였으며, 해당 자료는 공공데이터포털과 국가통계포털(KOSIS)에서 무료로 내려받으실 수 있습니다. 공공누리 제1유형은 Creative Commons 저작자표시 (CC BY)와 동일한 조건으로, 출처를 표시하면 누구나 자유롭게 이용할 수 있습니다.
