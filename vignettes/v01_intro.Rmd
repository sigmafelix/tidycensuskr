...
print(length(unique(substr(adm2_2020$adm2_code, 1, 2))))
...
Columns containing the values are added as a wide form. The column `adm2_code` links census data to boundary files retrieved with `load_districts()`.

```{r, include = TRUE}
df_2020 <- anycensus(year = 2020, type = "mortality")
head(df_2020)
