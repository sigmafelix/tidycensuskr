...
- **_Si-Gun-Gu_**: The second level, which includes cities and counties.
  ...
  - **_Gu_**: District/Ward. Districts are urban areas within metropolitan cities (these districts are called autonomous districts), whereas districts in autonomous cities are called non-autonomous districts.
- **_Eup-Myeon-Dong_**: The third level, which includes town and districts.
  - **_Eup_**: Town. Towns are urban areas within counties (Gun) with populations over 20,000.
  - **_Myeon_**: Township. Townships are rural areas within counties (Gun) with populations under 20,000.
  - **_Dong_**: Neighborhood. Neighborhoods are the smallest administrative units within cities (Si) and districts (Gu).


| South Korea | US | EU | UK(England) |
|---|---|---|---|
| _Si/Do_ | State  | NUTS[^1]1  | Regions/Combined Authorities |
| _Si/Gun/Gu_ | County | NUTS2 | County |
| _Eup/Myeon/Dong_ | Townships/Towns/Census County Division | NUTS3 | Districts/Wards/Boroughs |
...
| type | class1 | class2 | unit | description | available years |
|------|--------|--------|------|-------------|------|
| population | all households | total | persons | Total population | 2010, 2015, 2020 |
| population | all households | male | persons | Male population | 2010, 2015, 2020 |
| population | all households | female | persons | Female population | 2010, 2015, 2020 |
| tax | income | general | million KRW | Comprehensive Income Tax | 2020 |
| tax | income | labor | million KRW | Employment Income Tax | 2020 |
| mortality | All causes | total | per 100k population | Age-standardized mortality rate | 2020 |
| mortality | All causes | male | per 100k population | Age-standardized mortality rate (male) | 2020 |
| mortality | All causes | female | per 100k population | Age-standardized mortality rate (female) | 2020 |
| economy | company | total | count | Number of business entities | 2010, 2015, 2020 |
...
If you open the `censuskor` dataset, you will see **5,178 rows and 10 columns**. This is a fairly substantial size.  
