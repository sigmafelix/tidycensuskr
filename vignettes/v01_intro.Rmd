...
tidycensuskr will work at its full potential with the companion data package `tidycensussfkr`, which contains the district boundaries of South Korea. The package can be installed from R-universe:
```r
