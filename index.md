...
[![](reference/figures/gat.jpg)](https://sigmafelix.github.io/tidycensuskr/)
...
As of version 0.2.8.1, this package contains two datasets: Census data
...
- The function
  ...
  allows you to query census data for specific district or province
  codes and types of data (population, tax, mortality, economy, housing)
...
[`anycensus()`](https://sigmafelix.github.io/tidycensuskr/reference/anycensus.md)
will return an analysis-ready data.frame that can be easily merged with
the corresponding boundary `sf` object from
[`load_districts()`](https://sigmafelix.github.io/tidycensuskr/reference/load_districts.md).
...
![](reference/figures/README-mapmaking-1.png)
...
retrieved `data.frame` and `sf` object with
...
![](reference/figures/README-seoul_map-1.png)
...
![](reference/figures/README-final_map-1.png)

## Filter nonautonomous districts

[`detect_adm2_type()`](https://sigmafelix.github.io/tidycensuskr/reference/detect_adm2_type.md)
can be used to detect nonautonomous districts (i.e., districts that are
not independent administrative units but are part of larger cities, per
*Local Autonomy Act*). This is particularly useful when you want to
