...
pop <- censuskor |>
  dplyr::filter(
    type == "population" & class1 == "all households" & is.na(adm3_code)
  ) |>
...
```
    ...
    ##   <dbl> <chr>     <dbl> <chr>     <chr> <chr>    <chr>  <chr>  <chr> <dbl> <chr>
    ## 1  2020 Seoul        11 Jongno-gu 11010 populat… all h… female pers…  72.6 NA   
    ## 2  2015 Seoul        11 Jongno-gu 11010 populat… all h… female pers…  73.8 NA   
    ## 3  2010 Seoul        11 Jongno-gu 11010 populat… all h… female pers…  76.5 NA   
    ## 4  2020 Seoul        11 Jongno-gu 11010 populat… all h… male   pers…  67.3 NA   
    ## 5  2015 Seoul        11 Jongno-gu 11010 populat… all h… male   pers…  69.5 NA   
    ## 6  2010 Seoul        11 Jongno-gu 11010 populat… all h… male   pers…  71.3 NA   
...
kr_grid_adm2_sgis_2020 <-
  ...
  dplyr::mutate(
    name = dplyr::case_when(
      ...
      grepl("^21", code) & name == "Jung-gu" ~ "Jung-gu (BS)",
      ...
      grepl("^21", code) & name == "Seo-gu" ~ "Seo-gu (BS)",
      ...
      grepl("^21", code) & name == "Buk-gu" ~ "Buk-gu (BS)",
      ...
      grepl("^21", code) & name == "Gangseo-gu" ~ "Gangseo-gu (BS)",
      TRUE ~ name
    )
  ) |>
  dplyr::mutate(
