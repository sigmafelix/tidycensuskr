...
This package's data is derived from the Korean Statistical Information Service (https://kosis.kr) and Public Data Portal (https://www.data.go.kr). The data is provided under the Korea Open Government License Type 1 (Attribution).
