...
As of version 0.2.8.1, this package contains two datasets: Census data (`censuskor`) and the corresponding geospatial data.
...
* The function `load_districts()` allows you to get the _Si-Gun-Gu_ level `sf` files for the three census years (2010, 2015, 2020).
...
This package's data is derived from the Korean Statistical Information Service ([KOSIS](https://kosis.kr)) and Public Data Portal ([data.go.kr](https://data.go.kr)). The data is provided under the [Korea Open Government License Type 1 (Attribution)](https://www.kogl.or.kr/info/license.do) (Note: in Korean).
