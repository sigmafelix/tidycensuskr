...
This package's data is derived from the Korean Statistical Information Service ([KOSIS](https://kosis.kr)) and Public Data Portal ([data.go.kr](https://data.go.kr)). The data is provided under the Korea Open Government License Type 1 (Attribution).
